...
class CustomSearchView : View {
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        ...
        mExampleString = a.getString(
                R.styleable.CustomSearchView_exampleString)
        mExampleColor = a.getColor(
                R.styleable.CustomSearchView_exampleColor,
                mExampleColor)
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.CustomSearchView_exampleDimension,
                mExampleDimension)

        if (a.hasValue(R.styleable.CustomSearchView_exampleDrawable)) {
            exampleDrawable = a.getDrawable(
                    R.styleable.CustomSearchView_exampleDrawable)
